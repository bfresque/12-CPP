...
void	DiamondTrap::whoAmI()
{
	if (this->_energyPoints <= 0)
		std::cout << RED << "DiamondTrap " << this->_name << " tried to express himself, but has no energy left." << RESET << std::endl;
	else if(this->_hitPoints <= 0)
		std::cout << RED << "DiamondTrap " << this->_name << " tried to express himself, but has no hit points left." << RESET << std::endl;
	else
